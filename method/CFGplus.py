    ...
    with self.progress_bar(total=num_inference_steps) as progress_bar:
        for i, t in enumerate(timesteps):
            ...
            if True:
                ...
                weight = self.guidance_scale/12.5
                weight = (weight<1)*weight + (weight>1)
                noise_pred = noise_pred_uncond + weight * (noise_pred_text - noise_pred_uncond)
                ...
                latents = (latents - sigma * noise_pred) + sigma_next * noise_pred_uncond 
